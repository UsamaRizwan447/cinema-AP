...
public class finalServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        obj.changeMovieScheduleInCinema(obj.getAdminHelper().getCinema(),obj.getAdminHelper().getMovie(),obj.getAdminHelper().getSlot(),obj.getAdminHelper().getGenre(),obj.getAdminHelper().getDay());
    PrintWriter out = response.getWriter();
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Movie Changed');");
                out.println("location='UpdateMovieSchedule.jsp';");
                out.println("</script>");
    }
